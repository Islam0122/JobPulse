...
<b>Что умеет бот:</b>
• Помогает находить подходящие вакансии  
• Учитывает твой профиль и предпочтения  
• Присылает уведомления автоматически  
• Анализирует твои реакции и улучшает рекомендации  

<b>Разделы меню:</b>
💼 Вакансии — просмотр и рекомендации  
📊 Мой профиль — твои данные и настройки  
📈 Аналитика — статистика и советы  
❓ Помощь — этот экран  

<b>Как работать с вакансиями:</b>
1️⃣ Открой раздел «Вакансии»  
2️⃣ Просматривай рекомендации  
3️⃣ Оценивай 👍 или 👎  
4️⃣ Добавляй лучшие в ⭐️ избранное  

<b>Как это работает:</b>
1️⃣ Ты заполняешь профиль  
2️⃣ Бот парсит вакансии с HH.ru  
3️⃣ Алгоритм подбирает релевантные варианты  
4️⃣ Ты получаешь уведомления и рекомендации  

<b>Частота уведомлений:</b>
• Сразу 🔔 — при появлении подходящей вакансии  
• Ежедневно 📅 — краткий дайджест  
• Еженедельно 📆 — сводка и аналитика  

<b>Об авторе:</b>
Бот создан разработчиком, который сам прошёл путь поиска работы в IT.  
Цель проекта — автоматизировать рутину, убрать лишний шум  
и помочь быстрее находить действительно подходящие вакансии.  

Проект развивается и со временем будет получать новые функции:  
умную аналитику, более точные рекомендации и персональные советы.
